...
export const products: Product[] = [
  ...
  {
    id: 9,
    name: "Custom Built V8 Crate Engine with ITBs",
    category: "Engine",
    brand: "Race Spec",
    price: 15999.00,
    ...
    reviews: 12,
    inStock: true,
    description: "Fully built high-performance V8 crate engine featuring carbon fiber individual throttle bodies (ITBs) and stainless steel headers.",
    specs: [
      { label: "Displacement", value: "5.0L" },
      { label: "Horsepower", value: "650 HP" },
      { label: "Induction", value: "Carbon Fiber ITBs" },
      { label: "Headers", value: "Stainless Tubular" }
    ],
    compatibleVehicles: ["Universal", "Custom Builds", "Track Cars"],
    sku: "RS-V8-ITB-650"
  },
  {
    id: 10,
    ...
    brand: "Morimoto",
    price: 1250.00,
    image: "/led_headlights.png",
    rating: 4.8,
    reviews: 145,
    inStock: true,
    description: "High-performance LED headlights featuring aggressive DRL styling and superior nighttime visibility.",
    specs: [
      { label: "Bulb Type", value: "Osram LED" },
      { label: "Housing", value: "Piano Black" },
      { label: "DRL", value: "Sequential LED" },
      { label: "Warranty", value: "5 Years" }
    ],
    compatibleVehicles: ["Ford Mustang", "Chevy Corvette", "Porsche 911"],
    sku: "MOR-XB-LED"
  },
  {
    id: 11,
    name: "Recaro Podium Carbon Fiber Seats",
    category: "Interior",
    brand: "Recaro",
    price: 2995.00,
    image: "/racing_seats.png",
    rating: 5.0,
    reviews: 87,
    inStock: true,
    description: "Ultra-lightweight carbon fiber racing bucket seats finished in premium black alcantara with red stitching.",
    specs: [
      { label: "Material", value: "Carbon Fiber/Alcantara" },
      { label: "Weight", value: "4.3 kg" },
      { label: "FIA Approved", value: "Yes" },
      { label: "Harness", value: "4/5/6 Point" }
    ],
    compatibleVehicles: ["Universal (Requires Brackets)"],
    sku: "REC-POD-CF"
  }
];
...
export const reviews = [
  ...
  },
  {
    ...
    rating: 5,
    date: "3 weeks ago",
    text: "The TE37s are legendary for a reason. Perfect fitment and the weight savings are noticeable. Sunshine Auto Parts delivered quickly with great packaging.",
